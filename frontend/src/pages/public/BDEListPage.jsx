      ...
      <div className="bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50 min-h-screen">
        ...
        <header className="bg-white shadow-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <h1 className="text-3xl font-bold text-gray-900">Les BDE de l'IUT</h1>
          </div>
        </header>
            ...
            {bdes.map((bde) => (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${bde.colors?.primary || '#8B3FBF'} 0%, ${
                      bde.colors?.secondary || '#A855F7'
                    } 100%)`,
                  }}
                >
                  {bde.logo?.url && (
                ...
                {/* Content */}
                <div className="p-6">
                  <h2 className="text-2xl font-bold text-gray-900 mb-2">{bde.name}</h2>
                  <p className="text-sm text-gray-600 font-medium mb-3">{bde.fullName}</p>
                  <p className="text-gray-700 mb-4 line-clamp-3">{bde.description}</p>

                  {/* Social Links */}
                  {(bde.socialLinks?.instagram || bde.socialLinks?.facebook) && (
