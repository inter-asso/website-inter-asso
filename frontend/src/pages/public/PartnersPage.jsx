        ...
        <header className="bg-white shadow-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div>
              ...
              <p className="text-gray-600 mt-2">Profitez des avantages exclusifs avec votre carte BDE</p>
            </div>
          </div>
        </header>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {loading ? (
          ...
          <div className="text-center py-12 bg-white rounded-lg shadow">
            <p className="text-gray-500 text-lg">Aucun partenaire trouvé dans cette catégorie</p>
          </div>
        ) : (
            ...
            {partners.map((partner) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {/* Name */}
                  <h2 className="text-xl font-bold text-gray-900 mb-3">{partner.name}</h2>
                  ...
                  {partner.benefits && partner.benefits.length > 0 && (
                    <div className="mb-4">
                      <h3 className="text-sm font-semibold text-gray-900 mb-2">Avantages :</h3>
