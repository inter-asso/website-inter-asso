...
export default function HomePage() {
  ...
  return (
    <PublicLayout>
      {/* Hero Section */}
      <div ref={heroRef} className="bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          ...
          >
            <div className="text-4xl mb-4">🤝</div>
            <h3 className="text-xl font-bold text-gray-900 mb-2">Partenaires</h3>
            <p className="text-gray-600">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="feature-card bg-white rounded-lg p-6 shadow-md">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-lg font-medium text-gray-900">Validation centralisée</h3>
                  <p className="mt-2 text-gray-600">
                    L'Admin Interasso valide tous les événements des BDE avant publication
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="feature-card bg-white rounded-lg p-6 shadow-md">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-2 text-gray-600">
                    Recevez des notifications pour chaque validation ou rejet d'événement
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="feature-card bg-white rounded-lg p-6 shadow-md">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-2 text-gray-600">
                    Consultez les statistiques de validation et d'activité de chaque BDE
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="feature-card bg-white rounded-lg p-6 shadow-md">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-lg font-medium text-gray-900">Interface moderne</h3>
                  <p className="mt-2 text-gray-600">
